...
import com.spring.test.context.approach3.IntegrationTestBase3;
import com.spring.test.context.approach4.IntegrationTestBase4;
...
@ContextConfiguration(classes = IntegrationTestBase4.class)
@ActiveProfiles("test")
public class ApplicationServiceIntegrationTest4 {
    ...
    @Test
    @Sql(value = "/test-data-guests.sql")
