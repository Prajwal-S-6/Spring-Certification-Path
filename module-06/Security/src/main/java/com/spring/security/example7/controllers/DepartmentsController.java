package com.spring.security.example7.controllers;

import com.spring.security.example7.dao.DepartmentDao;
...
public class DepartmentsController {
    ...
    @RolesAllowed(DEPARTMENTS_DELETE)
