...
public class SpringBean1 {
    ...
    @Value("#{T(com.certification.spring.preparation.example6.beans.SpringBean2).staticMethod()}")
    private String staticMethodExecutionResult;

    @Value("#{T(com.certification.spring.preparation.example6.beans.SpringBean2).STATIC_VALUE}")
